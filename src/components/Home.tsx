    ...
    return (
        <section id="home" className="min-h-screen flex items-center justify-center bg-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-stone-600 text-md mb-6 sm:text-lg md:text-xl max-w-2xl mx-auto">Innovative Full-Stack Developer passionate about writing clean, maintainable code and leveraging modern technologies to streamline the transition from idea to production.</p>
            ...
            <div className="flex space-x-5 justify-center mt-10 text-gray-500">
